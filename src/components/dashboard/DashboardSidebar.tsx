...
export default function DashboardSidebar({displayName, avatarUrl, balance, locale, labels, logoutAction}: DashboardSidebarProps) {
  ...
  return (
    <aside className="border-b border-outline-variant/45 bg-background/90 py-5 backdrop-blur lg:sticky lg:top-20 lg:max-h-[calc(100dvh-6rem)] lg:self-start lg:overflow-y-auto lg:border-b-0 lg:border-r lg:py-8 lg:pr-6">
