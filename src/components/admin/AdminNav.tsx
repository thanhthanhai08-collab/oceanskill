...
export default function AdminNav({locale, active}:{locale:string;active:"skills"|"authors"|"collections"|"blog"}) {
  const vi=locale==="vi"; const items=[{id:"skills",label:vi?"Skill":"Skills"},{id:"authors",label:vi?"Tác giả":"Authors"},{id:"collections",label:vi?"Bộ sưu tập":"Collections"},{id:"blog",label:"Blog"}] as const;
