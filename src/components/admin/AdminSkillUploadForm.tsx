...
function errorLabel(code: string | undefined, labels: Record<string, string>) {
  ...
  if (code === "invalid_bundle_type") return labels.errorArchiveType;
