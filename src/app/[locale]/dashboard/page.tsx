  ...
  return (
    <>
      ...
      <section className="relative mt-10 overflow-hidden border-y border-primary/35 bg-primary/[.055] px-6 py-9 sm:px-8 lg:grid lg:grid-cols-12 lg:items-end lg:gap-8 lg:py-10">
        ...
        <div className="relative mt-7 lg:col-span-4 lg:mt-0 lg:text-right"><a href={`/${locale}/dashboard/billing/topup`} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md bg-primary-container px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:brightness-110"><span className="material-symbols-outlined text-[18px]">add</span>{t("topUp")}</a></div>
      </section>
